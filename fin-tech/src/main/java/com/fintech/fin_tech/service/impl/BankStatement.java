...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\acer\\Downloads\\MyStatement.pdf";
    private UserRepository userRepository;
    private EmailService emailService;

    /**
     * retrive list of transactions within a data range given an account number
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("FinTech"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.GRAY);
        bankName.setPadding(20f);

        PdfPCell bankAccount = new PdfPCell(new Phrase("Andheri West, Mumbai"));
        bankAccount.setBorder(0);
        bankInfoTable.addCell(bankName);
        bankInfoTable.addCell(bankAccount);
